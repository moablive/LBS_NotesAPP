...
**Contexto do Projeto:**
Este é um projeto pessoal pertencente ao perfil **moablive**. PWA de gestão de conhecimento — editor de blocos/Markdown, grafo de conexões, Zettelkasten —, parte da suíte **LifeBusinessSuit**.
...
```bash
cd ../ && git add LBS_NotesAPP && git commit -m "chore(submodulos): reaponta o LBS_NotesAPP"
```
