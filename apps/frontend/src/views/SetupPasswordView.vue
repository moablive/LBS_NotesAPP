    ...
    <div v-else class="relative z-10 w-full max-w-[420px] animate-fade-in-up">
      <div class="bg-surface-raised/60 backdrop-blur-xl border border-white/10 p-10 rounded-[2rem] shadow-modal">
        ...
        <div class="text-center mb-10">
          <img src="/favicon.svg" alt="NotesAPP" class="w-20 h-20 mx-auto mb-6 rounded-2xl shadow-lg object-contain bg-white/5 p-1" />
          <h1 class="text-3xl font-display font-semibold tracking-tight">Defina sua senha</h1>
          <p class="text-muted mt-2">Primeiro acesso ao NotesAPP. Escolha uma senha segura.</p>
        </div>
