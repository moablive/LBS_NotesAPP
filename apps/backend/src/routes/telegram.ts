 ...
 *
 * Sem migração de namespace aqui: o NotesAPP sempre chaveou por `loginhub_id`
 * (a coluna se chama `user_id`, mas o que ela guarda é o id do hub), e o
 * `telegram_id` só serve para o bot descobrir de quem é o chat.
 */
